...
//
//  MyRunningTripsViewController.swift
//  ODDS-Driver
//
...
class MyRunningTripsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if aryData.count > 0 {
            ...
            cell.lblTripDistanceTitle.text = "PASSENGER NAME".localized
            ...
            if let pickupTime = dictData[ "CreatedDate"] as? String {
                if pickupTime == "" {
            ...
            if let receiverName = dictData["ReceiverName"] as? String, !receiverName.isEmpty {
...
//                }
            ...
            if let ParcelArray = dictData["ParcelInfo"] as? [[String:Any]] {
